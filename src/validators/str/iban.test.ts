...
describe('iban', () => {
  test('validate that a string is in an iban format', () => {
    expect(IBAN('DE89 3704 0044 0532 0130 00')).toBe(true)
    expect(IBAN('AT61 1904 3002 3457 3201')).toBe(true)
    expect(IBAN('FR14 2004 1010 0505 0001 3')).toBe(false)
    ...
    validIBANs.forEach((iban) => expect(IBAN(iban)).toBe(true))
  })

  test('test alias', () => {
    expect(isIBAN).toBe(IBAN)
  })
})
